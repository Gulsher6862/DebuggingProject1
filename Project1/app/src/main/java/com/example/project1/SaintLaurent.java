...
public class SaintLaurent extends AppCompatActivity {

    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private CollectionReference productCollection = db.collection("Products");
    private Query mQuery = productCollection.whereEqualTo("name", "Yves Saint Laurent");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saint_laurent);

        getSupportActionBar().setTitle("Saint Laurent Perfumes");
